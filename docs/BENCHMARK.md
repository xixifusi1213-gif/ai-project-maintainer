...
It is not an exploit corpus and it does not claim any project is absolutely safe. It records public upstream evidence, generated APM reports, repair-pack tasks, and remaining production gaps.
...
| --- | --- | --- |
| Electron desktop | SiYuan Electron RCE | [GHSA-x63q-3rcj-hhp5](https://github.com/siyuan-note/siyuan/security/advisories/GHSA-x63q-3rcj-hhp5) |
| Database | Ghost Content API SQL injection | [GHSA-w52v-v783-gw97](https://github.com/TryGhost/Ghost/security/advisories/GHSA-w52v-v783-gw97) |
...
| CI / supply chain | tj-actions/changed-files compromise | [GHSA-mrrh-fwg8-r2c3](https://github.com/advisories/GHSA-mrrh-fwg8-r2c3), [CISA alert](https://www.cisa.gov/news-events/alerts/2025/03/18/supply-chain-compromise-third-party-tj-actionschanged-files-cve-2025-30066-and-reviewdogaction) |
...
The benchmark intentionally keeps `GAP` visible after code or workflow fixes. That is the point: production maintenance is not only code correctness.
