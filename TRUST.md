...
- release trust evidence linked npm provenance, GitHub Actions, SBOMs, release manifests, and GitHub Release assets
...
Starting with v1.0.0, official releases are intended to be published by GitHub Actions through npm Trusted Publishing.

The release workflow produces or attaches:

- npm provenance from GitHub Actions OIDC
- a CycloneDX SBOM
- a release manifest with SHA256 hashes
- a security report generated by the tool's own gate
- GitHub Release assets that match the published npm package

See [Release Trust](docs/RELEASE-TRUST.md) for verification commands.
